...
public class Http2FrameWrapperHolder {
    private static final Logger LOGGER = LoggerFactory.getLogger(Http2FrameWrapperHolder.class);

    List<Http2FrameWrapper<?>> frames;

    public Http2FrameWrapperHolder(List<Http2FrameWrapper<?>> frames) {
        this.frames = frames;
    }
    ...
    public void setFrames(List<Http2FrameWrapper<?>> frames) {
        this.frames = frames;
    }
}