...
public class FullHttp2Response {
    Http2Headers headers;
    ByteBuf content;

    public FullHttp2Response(Http2Headers headers, ByteBuf content) {
    ...
    public Charset getCharSet() {
        CharSequence contentType = (headers != null)? headers.get(HttpHeaderNames.CONTENT_TYPE) : null;
        if (contentType != null) {
