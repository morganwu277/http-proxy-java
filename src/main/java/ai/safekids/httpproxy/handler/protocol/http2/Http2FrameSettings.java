...
public class Http2FrameSettings {
    Integer headerPadding;
    Integer dataPadding;
    ...
    public Integer getHeaderPadding() {
    ...
    public Integer getDataPadding() {
        return dataPadding;
    }

    public void setDataPadding(Integer dataPadding) {
