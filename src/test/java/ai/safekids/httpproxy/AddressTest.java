...
public class AddressTest {
    ...
    public void shouldResolve() {
        Assert.assertEquals(Address.address("localhost", 80), Address.resolve("localhost:80"));
        Assert.assertEquals(Address.address("localhost", 80), Address.resolve("localhost", 80));
        Assert.assertEquals(Address.address("www.google.com", 443), Address.resolve("www.google.com:443"));
        Assert.assertEquals(Address.address("www.google.com", 443), Address.resolve("www.google.com", 443));
    }

    @Test
    public void shouldResolveFailed() {
        assertThatThrownBy(() -> Address.resolve("localhost"));
    }
}
